...
/* 		cp.add(br); */
    ...
    public void actionPerformed(ActionEvent e)
	{
		...
		if (e.getSource()==saveButton)
		{
			...
			int returnVal = fc.showDialog(this, "Save person object");
			...
			//save map
			final JFileChooser fmc = new JFileChooser();
			int returnValm = fmc.showDialog(this, "Save map object");

			if (returnValm == JFileChooser.APPROVE_OPTION)
			{
				File file = fmc.getSelectedFile();
				try
				{
					FileOutputStream fileOut = new FileOutputStream(file);
					ObjectOutputStream out = new ObjectOutputStream(fileOut);
		...
		if (e.getSource()==openButton)
		{
			//open person
			final JFileChooser fc = new JFileChooser();
			int returnVal = fc.showDialog(this, "Open person object");
			...
			//open map
			final JFileChooser fmc = new JFileChooser();
			int returnValm = fmc.showDialog(this, "Open map object");
